...
public static class TextBoxBeforeTextChangingEventArgsWrapper
{
    ...
    /// <returns><c>true</c> to cancel the text changes; otherwise, <c>false</c>.</returns>
    ...
    /// </summary>
    /// <param name="e">The requested <see cref="TextBoxBeforeTextChangingEventArgs"/>.</param>
    /// <param name="cancel"><c>true</c> to cancel the text changes; otherwise, <c>false</c>.</param>
