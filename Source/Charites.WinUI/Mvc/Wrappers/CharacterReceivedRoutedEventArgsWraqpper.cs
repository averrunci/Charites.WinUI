...
public static class CharacterReceivedRoutedEventArgsWrapper
{
    ...
    /// <summary>
    /// Gets the composed character associated with the <see cref="UIElement.CharacterReceived"/> event.
    /// </summary>
    /// <param name="e">The requested <see cref="CharacterReceivedRoutedEventArgs"/>.</param>
    /// <returns>The composed character associated with the <see cref="UIElement.CharacterReceived"/> event.</returns>
    ...
    public static object? OriginalSource(this CharacterReceivedRoutedEventArgs e) => Resolver.OriginalSource(e);
