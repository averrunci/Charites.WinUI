...
public static class SplitViewPaneClosingEventArgsWrapper
{
    ...
    /// <returns><c>true</c> to cancel the pane closing action; otherwise, <c>false</c>.</returns>
    public static bool Cancel(this SplitViewPaneClosingEventArgs e) => Resolver.Cancel(e);

    /// <summary>
    /// Sets a value that indicates whether the pane closing action should be canceled.
    /// </summary>
    /// <param name="e">The requested <see cref="SplitViewPaneClosingEventArgs"/>.</param>
    /// <param name="cancel"><c>true</c> to cancel the pane closing action; otherwise, <c>false</c>.</param>
    public static void Cancel(this SplitViewPaneClosingEventArgs e, bool cancel) => Resolver.Cancel(e, cancel);
