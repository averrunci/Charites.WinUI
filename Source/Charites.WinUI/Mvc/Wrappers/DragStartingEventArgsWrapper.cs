...
public static class DragStartingEventArgsWrapper
{
    ...
    /// </summary>
    /// <param name="e">The requested <see cref="DragStartingEventArgs"/>.</param>
    /// <param name="allowedOperations">The allowed data operations.</param>
    public static void AllowedOperations(this DragStartingEventArgs e, DataPackageOperation allowedOperations) => Resolver.AllowedOperations(e, allowedOperations);

    /// <summary>
    /// Gets a value that indicates whether the drag action should be canceled.
    /// </summary>
    /// <param name="e">The requested <see cref="DragStartingEventArgs"/>.</param>
    /// <returns><c>true</c> to cancel the drag action; otherwise, <c>false</c>.</returns>
    ...
    /// </summary>
    /// <param name="e">The requested <see cref="DragStartingEventArgs"/>.</param>
    /// <param name="cancel"><c>true</c> to cancel the drag action; otherwise, <c>false</c>.</param>
    ...
    private sealed class DefaultDragStartingEventArgsResolver : IDragStartingEventArgsResolver
    {
        ...
        void IDragStartingEventArgsResolver.AllowedOperations(DragStartingEventArgs e, DataPackageOperation allowedOperations) => e.AllowedOperations = allowedOperations;
...
public interface IDragStartingEventArgsResolver
{
    ...
    /// <param name="e">The requested <see cref="DragStartingEventArgs"/>.</param>
    /// <param name="allowedOperations">The allowed data operations.</param>
    void AllowedOperations(DragStartingEventArgs e, DataPackageOperation allowedOperations);
