...
public static class ManipulationInertiaStartingRoutedEventArgsWrapper
{
    ...
    /// </summary>
    /// <param name="e">The requested <see cref="ManipulationInertiaStartingRoutedEventArgs"/>.</param>
    /// <param name="expansionBehavior">The rate of slowdown of expansion inertial movement.</param>
    ...
    /// <summary>
    /// Gets the <see cref="PointerDeviceType"/> for the pointer device involved in the manipulation.
    /// </summary>
    /// <param name="e">The requested <see cref="ManipulationInertiaStartingRoutedEventArgs"/>.</param>
    ...
    public static void TranslationBehavior(this ManipulationInertiaStartingRoutedEventArgs e, InertiaTranslationBehavior translationBehavior) => Resolver.TranslationBehavior(e, translationBehavior);
