...
public static class LosingFocusEventArgsWrapper
{
    ...
    public static Guid CorrelationId(this LosingFocusEventArgs e) => Resolver.CorrelationId(e);
    ...
    /// </returns>
    public static bool Handled(this LosingFocusEventArgs e) => Resolver.Handled(e);
