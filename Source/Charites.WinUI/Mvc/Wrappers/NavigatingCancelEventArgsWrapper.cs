...
public static class NavigatingCancelEventArgsWrapper
{
    ...
    /// <returns><c>true</c> to cancel the pending cancelable navigation; <c>false</c> to continue with navigation.</returns>
    public static bool Cancel(this NavigatingCancelEventArgs e) => Resolver.Cancel(e);

    /// <summary>
    /// Sets a value that indicates whether a pending navigation should be canceled.
    /// </summary>
    /// <param name="e">The requested <see cref="NavigatingCancelEventArgs"/>.</param>
    /// <param name="cancel"><c>true</c> to cancel the pending cancelable navigation; <c>false</c> to continue with navigation.</param>
    ...
    /// as a type reference (System.Type for Microsoft .NET, a TypeName helper struct for Visual C++ component extensions (C++/CX)).
    /// </returns>
