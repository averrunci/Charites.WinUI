...
public static class TreeViewItemInvokedEventArgsWrapper
{
    ...
    /// A true value for prevents most handlers along the event route from handling the same event again.
    /// </summary>
    ...
    /// <summary>
    /// Gets the <see cref="TreeView"/> item that is invoked.
    /// </summary>
    /// <param name="e">The requested <see cref="TreeViewItemInvokedEventArgs"/>.</param>
    /// <returns>The <see cref="TreeView"/> item that is invoked.</returns>
