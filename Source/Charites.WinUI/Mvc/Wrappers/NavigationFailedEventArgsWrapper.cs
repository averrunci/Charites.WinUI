...
public static class NavigationFailedEventArgsWrapper
{
    ...
    /// </summary>
    /// <param name="e">The requested <see cref="NavigationFailedEventArgs"/>.</param>
    /// <returns><c>true</c> if the failure event is handled; <c>false</c> if the failure event is not yet handled.</returns>
    ...
    /// </summary>
    /// <param name="e">The requested <see cref="NavigationFailedEventArgs"/>.</param>
    /// <param name="handled"><c>true</c> if the failure event is handled; <c>false</c> if the failure event is not yet handled.</param>
