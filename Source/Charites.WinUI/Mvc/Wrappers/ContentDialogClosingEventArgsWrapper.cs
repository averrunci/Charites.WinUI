...
public static class ContentDialogClosingEventArgsWrapper
{
    ...
    /// <summary>
    /// Gets a value that can cancel the closing of the dialog. A <c>true</c> value for Cancel cancels the default behavior.
    /// </summary>
    /// <param name="e">The requested <see cref="ContentDialogClosingEventArgs"/>.</param>
    /// <returns><c>true</c> to cancel the closing of the dialog; otherwise, <c>false</c>.</returns>
    public static bool Cancel(this ContentDialogClosingEventArgs e) => Resolver.Cancel(e);

    /// <summary>
    /// Sets a value that can cancel the closing of the dialog. A <c>true</c> value for Cancel cancels the default behavior.
    /// </summary>
    /// <param name="e">The requested <see cref="ContentDialogClosingEventArgs"/>.</param>
    /// <param name="cancel"><c>true</c> to cancel the closing of the dialog; otherwise, <c>false</c>.</param>
    ...
    /// <summary>
    /// Gets a <see cref="ContentDialogClosingDeferral"/> that the app can use to respond asynchronously to the closing event.
    /// </summary>
    /// <param name="e">The requested <see cref="ContentDialogClosingEventArgs"/>.</param>
    /// <returns>A <see cref="ContentDialogClosingDeferral"/> that the app can use to respond asynchronously to the closing event.</returns>
