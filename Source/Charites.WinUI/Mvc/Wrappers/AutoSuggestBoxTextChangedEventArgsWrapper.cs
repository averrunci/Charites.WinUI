...
public static class AutoSuggestBoxTextChangedEventArgsWrapper
{
    ...
    /// <summary>
    /// Gets a value that indicates the reason for the text changing in the <see cref="AutoSuggestBox"/>.
    /// </summary>
    /// <param name="e">The requested <see cref="AutoSuggestBoxTextChangedEventArgs"/>.</param>
    /// <returns>The reason for the text changing in the <see cref="AutoSuggestBox"/>.</returns>
    public static AutoSuggestionBoxTextChangeReason Reason(this AutoSuggestBoxTextChangedEventArgs e) => Resolver.Reason(e);

    /// <summary>
    /// Sets a value that indicates the reason for the text changing in the <see cref="AutoSuggestBox"/>.
    /// </summary>
    /// <param name="e">The requested <see cref="AutoSuggestBoxTextChangedEventArgs"/>.</param>
    /// <param name="reason">The reason for the text changing in the <see cref="AutoSuggestBox"/>.</param>
    ...
    /// <summary>
    /// Returns a Boolean value indicating if the current value of the <see cref="TextBox"/> is unchanged
    /// from the point in time when the <see cref="AutoSuggestBox.TextChanged"/> event was raised.
    /// </summary>
    /// <param name="e">The requested <see cref="AutoSuggestBoxTextChangedEventArgs"/>.</param>
    /// <returns>
    /// Indicates if the current value of the <see cref="TextBox"/> is unchanged from the point in time
    /// when the <see cref="AutoSuggestBoxTextChangedEventArgs"/> event was raised.
    /// </returns>
