...
public static class CandidateWindowBoundsChangedEventArgsWrapper
{
    ...
    /// <summary>
    /// Gets the <see cref="Rect"/> that defines the size and location of the Input Method Editor (IME) window,
    /// in the coordinate space of the text edit control.
    /// </summary>
    /// <param name="e">The requested <see cref="CandidateWindowBoundsChangedEventArgs"/>.</param>
    /// <returns>The <see cref="Rect"/> that defines the size and location of the Input Method Editor (IME) window</returns>
