...
public static class ContextRequestedEventArgsWrapper
{
    ...
    public static object? OriginalSource(this ContextRequestedEventArgs e) => Resolver.OriginalSource(e);

    /// <summary>
    /// Gets the x- and y-coordinates of the pointer position, optionally evaluated against a coordinate origin of a supplied <see cref="UIElement"/>.
    /// </summary>
    /// <param name="e">The requested <see cref="ContextRequestedEventArgs"/>.</param>
    ...
    /// </param>
    /// <returns><c>true</c> if the context request was initiated by a pointer device; otherwise, <c>false</c>.</returns>
    ...
    private sealed class DefaultContextRequestedEventArgsResolver : IContextRequestedEventArgsResolver
    {
        ...
        object? IContextRequestedEventArgsResolver.OriginalSource(ContextRequestedEventArgs e) => e.OriginalSource;
...
public interface IContextRequestedEventArgsResolver
{
    ...
    /// <param name="e">The requested <see cref="ContextRequestedEventArgs"/>.</param>
    /// <returns>The object that raised the event.</returns>
    object? OriginalSource(ContextRequestedEventArgs e);
