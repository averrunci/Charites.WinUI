...
public static class ManipulationStartingRoutedEventArgsWrapper
{
    ...
    /// <returns>The <see cref="UIElement"/> that is considered the container of the manipulation.</returns>
    public static UIElement Container(this ManipulationStartingRoutedEventArgs e) => Resolver.Container(e);

    /// <summary>
    /// Sets the <see cref="UIElement"/> that is considered the container of the manipulation.
    /// </summary>
    /// <param name="e">The requested <see cref="ManipulationStartingRoutedEventArgs"/>.</param>
    /// <param name="container">The <see cref="UIElement"/> that is considered the container of the manipulation.</param>
    public static void Container(this ManipulationStartingRoutedEventArgs e, UIElement container) => Resolver.Container(e, container);

    /// <summary>
    /// Gets a value that marks the routed event as handled.
    /// Setting to <c>true</c> prevents most handlers along the event route from handling the same event again.
    /// </summary>
    /// <param name="e">The requested <see cref="ManipulationStartingRoutedEventArgs"/>.</param>
    /// <returns>
    ...
    /// </summary>
    /// <param name="e">The requested <see cref="ManipulationStartingRoutedEventArgs"/>.</param>
    /// <param name="mode">One of the enumeration values.</param>
    ...
    private sealed class DefaultManipulationStartingRoutedEventArgsResolver : IManipulationStartingRoutedEventArgsResolver
    {
        ...
        void IManipulationStartingRoutedEventArgsResolver.Container(ManipulationStartingRoutedEventArgs e, UIElement container) => e.Container = container;
...
public interface IManipulationStartingRoutedEventArgsResolver
{
    ...
    /// <param name="e">The requested <see cref="ManipulationStartingRoutedEventArgs"/>.</param>
    /// <param name="container">The <see cref="UIElement"/> that is considered the container of the manipulation.</param>
    void Container(ManipulationStartingRoutedEventArgs e, UIElement container);
