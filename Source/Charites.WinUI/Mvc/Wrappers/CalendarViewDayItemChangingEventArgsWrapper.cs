...
public static class CalendarViewDayItemChangingEventArgsWrapper
{
    ...
    /// <summary>
    /// Gets a value that indicates whether this container is in the recycle queue of the <see cref="CalendarView"/> and is not being used to visualize a calendar item.
    /// </summary>
    /// <param name="e">The requested <see cref="CalendarViewDayItemChangingEventArgs"/>.</param>
    /// <returns><c>true</c> if the container is in the recycle queue of the <see cref="CalendarView"/>; otherwise, <c>false</c>.</returns>
    ...
    /// <param name="e">The requested <see cref="CalendarViewDayItemChangingEventArgs"/>.</param>
    /// <returns>
    /// The <see cref="CalendarViewDayItem"/> associated with this container, or <c>null</c> if no item is associated with this container.
    /// </returns>
