...
public static class ContentDialogButtonClickEventArgsWrapper
{
    ...
    /// <summary>
    /// Gets a <see cref="ContentDialogButtonClickDeferral"/> that the app can use to respond asynchronously to a button click event.
    /// </summary>
    /// <param name="e">The requested <see cref="ContentDialogButtonClickEventArgs"/>.</param>
    /// <returns>A <see cref="ContentDialogButtonClickDeferral"/> that the app can use to respond asynchronously to a button click event.</returns>
