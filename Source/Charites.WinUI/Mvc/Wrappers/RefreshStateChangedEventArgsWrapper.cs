...
public static class RefreshStateChangedEventArgsWrapper
{
    ...
    /// <summary>
    /// Gets a value that indicates the new state of the <see cref="RefreshVisualizer"/>.
    /// </summary>
    /// <param name="e">The requested <see cref="RefreshStateChangedEventArgs"/>.</param>
    /// <returns>An enumeration value that indicates the new state of the <see cref="RefreshVisualizer"/>.</returns>
    public static RefreshVisualizerState NewState(this RefreshStateChangedEventArgs e) => Resolver.NewState(e);

    /// <summary>
    /// Gets a value that indicates the previous state of the <see cref="RefreshVisualizer"/>.
    /// </summary>
    /// <param name="e">The requested <see cref="RefreshStateChangedEventArgs"/>.</param>
    /// <returns>An enumeration value that indicates the previous state of the <see cref="RefreshVisualizer"/>.</returns>
