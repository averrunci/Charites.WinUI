...
public static class DragItemsCompletedEventArgsWrapper
{
    ...
    /// </summary>
    public static IDragItemsCompletedEventArgsResolver Resolver { get; set; } = new DefaultDragItemsCompletedEventArgsResolver();
    ...
    private sealed class DefaultDragItemsCompletedEventArgsResolver : IDragItemsCompletedEventArgsResolver
    {
