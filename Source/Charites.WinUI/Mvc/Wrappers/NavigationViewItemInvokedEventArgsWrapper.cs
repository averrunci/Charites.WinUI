...
public static class NavigationViewItemInvokedEventArgsWrapper
{
    ...
    /// <summary>
    /// Gets a value that indicates whether the <see cref="NavigationViewItemInvokedEventArgs.InvokedItem"/> is the menu item for Settings.
    /// </summary>
    /// <param name="e">The requested <see cref="NavigationViewItemInvokedEventArgs"/>.</param>
    /// <returns>
    /// <c>true</c> if the <see cref="NavigationViewItemInvokedEventArgs.InvokedItem"/> is the menu item for Settings; otherwise, <c>false</c>.
    /// </returns>
