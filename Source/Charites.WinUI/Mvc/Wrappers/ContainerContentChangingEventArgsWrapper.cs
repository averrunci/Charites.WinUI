...
public static class ContainerContentChangingEventArgsWrapper
{
    ...
    /// <summary>
    /// Gets a value that indicates whether this container is in the recycle queue of the <see cref="ListViewBase"/>
    /// and is not being used to visualize a data item.
    /// </summary>
    /// <param name="e">The requested <see cref="ContainerContentChangingEventArgs"/>.</param>
    /// <returns>
    ...
    /// <summary>
    /// Gets the index in the <see cref="ItemsControl.ItemsSource"/> of the data item associated with this container.
    /// </summary>
    /// <param name="e">The requested <see cref="ContainerContentChangingEventArgs"/>.</param>
    /// <returns>The index in the <see cref="ItemsControl.ItemsSource"/> of the data item associated with this container.</returns>
