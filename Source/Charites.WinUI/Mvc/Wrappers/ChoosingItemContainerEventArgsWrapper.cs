...
public static class ChoosingItemContainerEventArgsWrapper
{
    ...
    /// <returns><c>true</c> if the container is ready for use; otherwise, <c>false</c>.</returns>
    ...
    /// </summary>
    /// <param name="e">The requested <see cref="ChoosingItemContainerEventArgs"/>.</param>
    /// <param name="isContainerPrepared"><c>true</c> if the container is ready for use; otherwise, <c>false</c>.</param>
    ...
    /// </summary>
    /// <param name="e">The requested <see cref="ChoosingItemContainerEventArgs"/>.</param>
    /// <param name="itemContainer">The UI container that will be used to display the current data item.</param>
    ...
    /// <summary>
    /// Gets the index in the <see cref="ItemsControl.ItemsSource"/> of the data item for which a container is being selected.
    /// </summary>
    /// <param name="e">The requested <see cref="ChoosingItemContainerEventArgs"/>.</param>
    /// <returns>The index in the <see cref="ItemsControl.ItemsSource"/> of the data item for which a container is being selected.</returns>
