...
public sealed class EventArgsResolverScopeBuilder<T>
{
    ...
    private EventArgsResolverScopeBuilder(T resolver, Type eventArgsWrapperType, string resolverPropertyName, IEnumerable<IEventArgsResolver> eventArgsResolvers)
    {
        ...
        this.eventArgsWrapperType = eventArgsWrapperType;
    ...
    public EventArgsResolverScopeEventHandlerBase EventHandlersOf(object controller)
        => new(eventArgsResolvers, WinUIController.Retrieve<WinUIEventHandlerExtension, EventHandlerBase<FrameworkElement, WinUIEventHandlerItem>>(controller));
}