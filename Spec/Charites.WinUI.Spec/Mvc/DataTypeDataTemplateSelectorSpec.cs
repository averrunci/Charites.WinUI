...
class DataTypeDataTemplateSelectorSpec : DispatcherContext
{
    ...
    class DataTemplateSelectionSampleDataSource : ISampleDataSource
    {
        IEnumerable ISampleDataSource.GetData()
        {
            ...
            yield return new
            {
                Description = "When the key is the full name of the data type and has a suffix 'Template'", Key = "Charites.Windows.Mvc.DataTypeDataTemplateSelectorSpec+TestData",
                Item = new TestData()
            };
            yield return new
            {
                Description = "When the key is the full name of the base data type", Key = "Charites.Windows.Mvc.DataTypeDataTemplateSelectorSpec+TestData", Item = new DerivedTestData()
            };
            yield return new
            {
                Description = "When the key is the full name of the base data type and has a suffix 'Template'", Key = "Charites.Windows.Mvc.DataTypeDataTemplateSelectorSpec+TestDataTemplate",
                Item = new DerivedTestData()
            };
            ...
            yield return new
            {
                Description = "When the key is the full name of the generic data type whose parameter type is string",
                Key = "Charites.Windows.Mvc.DataTypeDataTemplateSelectorSpec+GenericTestData`1[System.String]", Item = new GenericTestData<string>()
            };
            yield return new
            {
                Description = "When the key is the full name of the generic data type whose parameter type is string and has a suffix 'Template'",
                Key = "Charites.Windows.Mvc.DataTypeDataTemplateSelectorSpec+GenericTestData`1[System.String]Template", Item = new GenericTestData<string>()
            };
            yield return new
            {
                Description = "When the key is the full name of the generic data type whose parameter type is TestData",
                Key = "Charites.Windows.Mvc.DataTypeDataTemplateSelectorSpec+GenericTestData`1[Charites.Windows.Mvc.DataTypeDataTemplateSelectorSpec+TestData]", Item = new GenericTestData<TestData>()
            };
            yield return new
            {
                Description = "When the key is the full name of the generic data type whose parameter type is TestData and has a suffix 'Template'",
                Key = "Charites.Windows.Mvc.DataTypeDataTemplateSelectorSpec+GenericTestData`1[Charites.Windows.Mvc.DataTypeDataTemplateSelectorSpec+TestData]Template",
                Item = new GenericTestData<TestData>()
            };
            yield return new
            {
                Description = "When the key is the full name of the generic data type whose parameter type is string, but excluding type names",
                Key = "Charites.Windows.Mvc.DataTypeDataTemplateSelectorSpec+GenericTestData`1", Item = new GenericTestData<string>()
            };
            yield return new
            {
                Description = "When the key is the full name of the generic data type whose parameter type is string, but excluding type names and has a suffix 'Template'",
                Key = "Charites.Windows.Mvc.DataTypeDataTemplateSelectorSpec+GenericTestData`1Template", Item = new GenericTestData<string>()
            };
            yield return new
            {
                Description = "When the key is the full name of the generic data type whose parameter type is TestData, but excluding type names",
                Key = "Charites.Windows.Mvc.DataTypeDataTemplateSelectorSpec+GenericTestData`1", Item = new GenericTestData<TestData>()
            };
            yield return new
            {
                Description = "When the key is the full name of the generic data type whose parameter type is TestData, but excluding type names and has a suffix 'Template'",
                Key = "Charites.Windows.Mvc.DataTypeDataTemplateSelectorSpec+GenericTestData`1Template", Item = new GenericTestData<TestData>()
            };
            ...
            yield return new
            {
                Description = "When the key is the full name of the implemented interface", Key = "Charites.Windows.Mvc.DataTypeDataTemplateSelectorSpec+ITestData", Item = new TestData()
            };
            yield return new
            {
                Description = "When the key is the full name of the implemented interface and has a suffix 'Template'", Key = "Charites.Windows.Mvc.DataTypeDataTemplateSelectorSpec+ITestDataTemplate",
                Item = new TestData()
            };
        }
    }
    ...
    class DataTemplateNoSelectionSampleDataSource : ISampleDataSource
    {
        IEnumerable ISampleDataSource.GetData()
        {
            ...
            yield return new
            {
                Description = "When the key is the data type, does not contain generic parameters, and has a suffix 'Template'", Key = "GenericTestDataTemplate", Item = new GenericTestData<string>()
            };
        }
    }
    ...
    {
        TestElement element = default!;
        TestElement container = default!;
        ...
        await SetWindowContentAsync(container);
